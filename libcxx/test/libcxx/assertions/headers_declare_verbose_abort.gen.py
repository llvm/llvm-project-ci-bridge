...
for header in vars['public_headers']:
    ...
    test_condition_begin = f'#if {vars["header_restrictions"][header]}' if header in vars['header_restrictions'] else ''
    test_condition_end = '#endif' if header in vars['header_restrictions'] else ''
    print(f"""\
