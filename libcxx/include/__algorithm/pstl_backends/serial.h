...
void __pstl_for_each(__serial_backend, _ExecutionPolicy&&, _Iterator __first, _Iterator __last, _Fp __f) {
    std::for_each(__first, __last, __f);
}

template <class _ExecutionPolicy, class _Iterator, class _Tp, class _BinOp>
_LIBCPP_HIDE_FROM_ABI
_Tp __pstl_reduce(__serial_backend, _ExecutionPolicy&&, _Iterator __first, _Iterator __last, _Tp const& __value, _BinOp __op) {
...
_LIBCPP_HIDE_FROM_ABI
void __pstl_for_each_n(__serial_backend, _ExecutionPolicy&&, _Iterator __first, _Size __n, _Fp __f) {
