...
_LIBCPP_HIDE_FROM_ABI _ForwardIterator2 transform(
  ...
  if constexpr (__is_parallel_execution_policy_v<_ExecutionPolicy> &&
    ...
    std::__terminate_on_exception([&] {
      __pstl::__par_backend::__parallel_for(
          ...
          __first,
          __last,
          [&__policy, __op, __first, __result](_ForwardIterator1 __brick_first, _ForwardIterator1 __brick_last) {
    ...
    return __pstl::__unseq_backend::__simd_walk_2(
        ...
        __last - __first,
        __result,
        [&](__iter_reference<_ForwardIterator1> __in, __iter_reference<_ForwardIterator2> __out) {
          __out = __op(__in);
        });
  } else {
...
template <class _ExecutionPolicy,
          ...
          enable_if_t<is_execution_policy_v<__remove_cvref_t<_ExecutionPolicy>>, int> = 0>
_LIBCPP_HIDE_FROM_ABI _ForwardIterator3 transform(
    _ExecutionPolicy&& __policy,
    _ForwardIterator1 __first1,
    _ForwardIterator1 __last1,
    _ForwardIterator2 __first2,
    _ForwardIterator3 __result,
    _BinaryOperation __op) {
  if constexpr (__is_parallel_execution_policy_v<_ExecutionPolicy> &&
                __is_cpp17_random_access_iterator<_ForwardIterator1>::value &&
                __is_cpp17_random_access_iterator<_ForwardIterator2>::value &&
                __is_cpp17_random_access_iterator<_ForwardIterator3>::value) {
    std::__terminate_on_exception([&] {
      __pstl::__par_backend::__parallel_for(
          __pstl::__internal::__par_backend_tag{},
          __policy,
    ...
    return __pstl::__unseq_backend::__simd_walk_3(
        ...
        [&](__iter_reference<_ForwardIterator1> __in1,
            ...
            __iter_reference<_ForwardIterator3> __out) { __out = __op(__in1, __in2); });
  } else {
